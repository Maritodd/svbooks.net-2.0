    ...
    return (
        <div className="header">
            <header className="header-container">
                ...
                <div className="header-container__link">
                    <NavLink to={"/services"} activeClassName="active" className="header-container__item dropdown"><span
            ...
            <div className="sidebar" >
                ...
                <div className="sidebar-container" >
                    <a href="https://www.facebook.com/Book-Restoration-Designs-LLC-2023844377712950/" target="_blank"><img className="sidebar-container__link slide-in-left" src={face} alt="facebook"/></a>
                    {/*<a href="tel:(224)616-4698 " target="_blank"><img className="sidebar-container__link slide-in-left" src={messenger} alt="messenger"/></a>*/}
                    <a href="mailto:sv_books@yahoo.com" target="_blank" ><img  className="sidebar-container__link slide-in-left" src={mail} alt="mail"/></a>
                </div>
            </div>
        </div>
